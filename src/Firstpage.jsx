	...
	return (
		<>
			<div className="all-body">
				<Navbar />
				<div id="landingPage">
					<img className="Front-logo mt-2" src="/logo-no-background.png" alt="Logo.." />
					<div className="searchDiv">
						<input type="text" className="searchBar form-control rounded" placeholder="Enter Keywords....."
					...
					<div className="website-details mt-3">
						...
						<p>
							<strong>
								<span>Is It legal to use MovieMania?</span>
							</strong><br />
							MovieMania is a legal and ethical online platform that operates strictly within the bounds of copyright laws.It adheres to a model of responsible and authorized content distribution. We are committed to promoting a legal and secure space for users to access movie information. MovieMania does not engage in or support any form of copyright infringement, ensuring that all content provided is sourced and presented in accordance with applicable laws. Our dedication to legality and ethical practices underscores our commitment to providing users with a reliable and compliant platform for exploring the vast world of cinema.
						</p>
						...
						<p>
							...
							- Private and safe source of details.<br />
							- Fast load times<br />
							- Fast and constant content updates.<br />
							- Optimized UI & UX.  <br />
							- Mobile-friendly and Chromecast supported.<br />
							- No ads, pop ups, or commercials.<br />
